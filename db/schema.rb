...
ActiveRecord::Schema.define(version: 20130806115447) do
  ...
  add_index "control_assessments", ["control_id"], name: "index_control_assessments_on_control_id", using: :btree
  add_index "control_assessments", ["pbc_list_id"], name: "index_control_assessments_on_pbc_list_id", using: :btree
  ...
  add_index "control_controls", ["control_id", "implemented_control_id"], name: "index_control_controls_uniqueness", unique: true, using: :btree
  add_index "control_controls", ["control_id"], name: "index_control_controls_on_control_id", using: :btree
  add_index "control_controls", ["implemented_control_id"], name: "index_control_controls_on_implemented_control_id", using: :btree
  ...
  add_index "control_sections", ["control_id", "section_id"], name: "index_control_control_objectives_uniqueness", unique: true, using: :btree
  add_index "control_sections", ["control_id"], name: "index_control_control_objectives_on_control_id", using: :btree
  add_index "control_sections", ["section_id"], name: "index_control_control_objectives_on_control_objective_id", using: :btree
  ...
  add_index "controls", ["directive_id"], name: "index_controls_on_regulation_id", using: :btree
  add_index "controls", ["slug"], name: "index_controls_on_slug", unique: true, using: :btree
  ...
  add_index "directives", ["slug"], name: "index_programs_on_slug", unique: true, using: :btree
  ...
  add_index "object_documents", ["documentable_type", "documentable_id"], name: "index_object_documents_on_documentable_type_and_documentable_id", using: :btree
  ...
  add_index "object_people", ["personable_type", "personable_id"], name: "index_object_people_on_personable_type_and_personable_id", using: :btree
  ...
  add_index "relationship_types", ["relationship_type"], name: "index_relationship_types_on_relationship_type", unique: true, using: :btree
  ...
  add_index "relationships", ["destination_id"], name: "index_relationships_on_destination_id", using: :btree
  add_index "relationships", ["destination_type"], name: "index_relationships_on_destination_type", using: :btree
  ...
  add_index "relationships", ["source_type"], name: "index_relationships_on_source_type", using: :btree
  ...
  add_index "requests", ["control_assessment_id"], name: "index_requests_on_control_assessment_id", using: :btree
  ...
  add_index "sections", ["directive_id"], name: "index_control_objectives_on_regulation_id", using: :btree
